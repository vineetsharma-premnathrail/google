...
const hasGoogleOAuth = Boolean(
  ...
  !process.env.NEXT_PUBLIC_GOOGLE_CLIENT_ID.startsWith("placeholder")
);
    ...
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <button
            onClick={() => googleLogin()}
            disabled={loading || !hasGoogleOAuth}
            title={!hasGoogleOAuth ? "Google OAuth not configured" : undefined}
            className="w-full flex items-center justify-center gap-3 bg-white hover:bg-gray-50 text-gray-800 font-semibold px-5 py-3 rounded-xl transition-colors border border-gray-200 mb-6 disabled:opacity-50 disabled:cursor-not-allowed"
          >
